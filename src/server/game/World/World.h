...
enum WorldBoolConfigs
{
    ...
    CONFIG_BATTLEGROUND_QUEUE_ANNOUNCER_CHANNEL,
    ...
    CONFIG_BOOL_PVP_CHARACTER_ALLOWTRADE,
    CONFIG_BOOL_PVP_CHARACTER_ALLOWAUCTIONHOUSE,
...
enum WorldIntConfigs
{
    ...
    CONFIG_XP_BOOST_ITEMID,
    CONFIG_XP_BOOST_PREMIUM_ITEMID,
    CONFIG_XP_BOOST_MAXLEVEL,
    ...
    CONFIG_INT_PVP_CHARACTER_MONEY,
...
enum Rates
{
    ...
    RATE_XP_BOOST_SOLO,
    RATE_XP_BOOST_GROUP,
    RATE_XP_BOOST_PREMIUM_SOLO,
    RATE_REP_BOOST_PREMIUM_SOLO,
    RATE_XP_BOOST_PREMIUM_GROUP,
    MAX_RATES
};
...
// PvP.Chars and PvE.Chars: Allowed items to trade
typedef std::map<std::string, bool> PvPCharsAllowedTradeItems;
...
class World
{
    ...
    protected:
        ...
        // This map contains all items that are allowed to trade between a PvP.Char
        // and a PvE.Char
        PvPCharsAllowedTradeItems mPvPCharsAllowedTradeItems;
    private:
